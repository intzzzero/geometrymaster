						...
						{user ? (
							<div className="flex items-center">
								...
								<a
									...
									className="px-4 py-2 text-sm text-[--color-toss-gray-600] hover:text-[--color-toss-blue] font-medium transition-colors cursor-pointer border-r border-[--color-toss-gray-200] flex items-center gap-2"
								>
									☕️ Buy Me a Coffee
								</a>
								<div
					...
					<div className="md:hidden border-t border-[--color-toss-gray-200] bg-white">
						<div className="px-4 py-2 space-y-1">
							...
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="block px-3 py-2 text-sm text-[--color-toss-gray-600] hover:text-[--color-toss-blue] hover:bg-[--color-toss-gray-50] rounded-[--radius-toss] transition-colors flex items-center gap-2"
								onClick={() => setShowMobileMenu(false)}
							>
								☕️ Buy Me a Coffee
							</a>
